(function ($) {
    ...
    var trade_window = $(window);

    // ****************************
    // :: 1.0 Preloader Active Code
    // ****************************

    trade_window.on('load', function () {
    ...
    // *************************************
    // :: 5.0 Feedback Slides Active Code
    // *************************************
    if ($.fn.owlCarousel) {
        var feedbackSlides = $('.feedback-user-content');
    ...
    // *********************************
    if ($.fn.magnificPopup) {
        $('.about-us-thumbnail a').magnificPopup({
            type: 'iframe'
        });
    }
    if ($.fn.magnificPopup) {
